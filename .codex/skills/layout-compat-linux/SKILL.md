...
When changing Options or a settings page, also read [the Options layout reference](references/options.md). It maps the page sources and screenshots and records Avalonia-specific initialization and rendering traps.
